...
class SidePanelManager:
    def __init__(self, master, status_df, dataaccess:DataAccess):
        ...
        required_columns = ['Books Given Status', 'Books Given Date', 'Grade Given']
    ...
    def show_selected_student_details_on_side_panel(self, student_id):
        print(f"Trying to load details for student_id: {student_id}")
    ...
    def save_details(self):
        ...
        student_id = entry_details.get('Student ID', '')
        if not student_id or student_id.strip() == '':
            print("No valid student selected, skipping save.")
        ...
        # Ensure the columns are the right type
        self.status_df['Books Given Status'] = self.status_df['Books Given Status'].astype(str)
        self.status_df['Books Given Date'] = self.status_df['Books Given Date'].astype(str)
        self.status_df['Grade Given'] = self.status_df['Grade Given'].astype(str)
