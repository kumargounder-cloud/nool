...
class StudentStatusUI:
    ...
    def display_student_list_and_side_panel(self, event):
        ...
        selected_student_id = None  # Initialize variable
        ...
        try:
            student_id_index = self.tree["columns"].index('Student ID')
            print(f"Student Index: {student_id_index}")
            selected_student_id = record_values[student_id_index]
        ...
        if selected_student_id is not None:
            student_row = self.students_df[self.students_df['Student ID'] == int(selected_student_id)]
            print(f"Student row data:\n{student_row}")
